...
export const metadata: Metadata = pageMeta({
  title: "Corporate K9 Services Ontario",
  description:
    "Corporate K9 consultation, working-dog assessment, detector and patrol dog evaluation, handler support and certification guidance across Ontario.",
...
const flow = [
  {
    step: "01",
    title: "Assessment",
    body: "Define operational needs and evaluate dogs, handlers and gaps.",
  },
  {
    step: "02",
    title: "Training Plan",
    body: "A structured plan matched to your mission and standards.",
  },
  {
    step: "03",
    title: "Handler Support",
    body: "Coaching to sharpen control, communication and consistency.",
  },
  {
    step: "04",
    title: "Evaluation",
    body: "Objective testing against real-world performance benchmarks.",
  },
  {
    step: "05",
    title: "Certification Support",
    body: "Preparation and guidance toward recognized certification.",
  },
];
          ...
          <Reveal className="relative overflow-hidden rounded-3xl border border-gold/20 bg-gradient-to-br from-navy to-gunmetal px-6 py-14 text-center sm:px-12">
            ...
            <div className="relative">
              ...
              <p className="body-lg mx-auto mt-5 max-w-xl">
                Request a corporate K9 consultation and we&apos;ll help you
                build, evaluate or certify a program you can depend on.
              </p>
