...
export const metadata: Metadata = pageMeta({
  title: "Dog Training Ontario",
  description:
    "Professional dog training across Ontario with retired Sergeant Paul Caissie, offering private training, behaviour support and corporate K9 services.",
  path: "/",
});
  ...
  return (
    <>
      ...
      <Section className="bg-ink">
        ...
        <div className="mt-10">
          <Button href="/private-dog-training">
        ...
        <div className="mx-auto max-w-3xl text-center">
          <Reveal>
            ...
            <h2 className="heading-lg mt-4">
              We Train the Dog —{" "}
              <span className="gold-text">and Teach the Owner</span>
            </h2>

            <p className="body-lg mx-auto mt-6">
              Real progress happens when the owner understands how to
              communicate, correct, guide and maintain the dog&apos;s behaviour.
              CCI&apos;s approach helps clients become confident handlers — not
              just temporary observers of training.
            </p>
          </Reveal>
        </div>
