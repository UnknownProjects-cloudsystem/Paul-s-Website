...
export const privateServices: ServiceItem[] = [
  ...
  },
  {
    ...
    short:
      "Modern, responsible low-level e-collar conditioning for dependable off-leash control.",
    icon: "ecollar",
  },
  {
...
export const servicePages: Record<string, ServicePage> = {
  "private-dog-training": {
    ...
    seoTitle: "Private Dog Training Ontario",
  ...
  "puppy-training": {
    ...
    seoTitle: "Puppy Training Durham Region & Ontario",
  ...
  "behaviour-training": {
    ...
    seoTitle: "Dog Behaviour Training Ontario",
  ...
  "e-collar-training": {
    ...
    seoTitle: "E-Collar Dog Training Ontario",
  ...
  "service-therapy-dog-training": {
    ...
    seoTitle: "Service & Therapy Dog Training Ontario",
